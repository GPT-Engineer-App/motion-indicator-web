...
import { Box, VStack, HStack, Image, NumberInput, NumberInputField, NumberInputStepper, NumberIncrementStepper, NumberDecrementStepper, Text, Badge } from "@chakra-ui/react";
    ...
    <Box p={4}>
      <VStack spacing={6}>
        ...
        <Box width="300px">
          ...
          <NumberInput value={threshold} min={0} max={255} step={1} onChange={handleThresholdChange}>
            <NumberInputField />
            <NumberInputStepper>
